...
import net.mcreator.instantbuidlings.procedures.Place_strangechurchProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Place_strangechurchProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

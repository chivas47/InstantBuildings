...
import net.mcreator.instantbuidlings.procedures.Place_boatProcedure;
...
public class BoatBlock extends InstantBuidlingsElements.ModElement {
	@ObjectHolder("instantbuidlings:boat")
	public static final Block block = null;
	public BoatBlock(InstantBuidlingsElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Place_boatProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

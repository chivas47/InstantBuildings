...
import net.mcreator.instantbuidlings.procedures.PlacevillagerhouseProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				PlacevillagerhouseProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

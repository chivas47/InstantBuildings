...
public class Place_guardpostProcedure extends InstantbuidlingsModElements.ModElement {
	public Place_guardpostProcedure(InstantbuidlingsModElements instance) {
		super(instance, 11);
	}

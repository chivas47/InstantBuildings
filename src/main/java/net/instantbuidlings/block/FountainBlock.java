...
import net.instantbuidlings.procedures.Place_fountainProcedure;
...
public class FountainBlock extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:fountain")
	public static final Block block = null;
	public FountainBlock(InstantbuidlingsModElements instance) {
		super(instance, 3);
	}

...
import net.instantbuidlings.procedures.Place_oldchurchProcedure;
...
public class OldchurchBlock extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:oldchurch")
	public static final Block block = null;
	public OldchurchBlock(InstantbuidlingsModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Place_oldchurchProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

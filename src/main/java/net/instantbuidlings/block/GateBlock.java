...
import net.instantbuidlings.procedures.Place_gateProcedure;
...
public class GateBlock extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:gate")
	public static final Block block = null;
	public GateBlock(InstantbuidlingsModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Place_gateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

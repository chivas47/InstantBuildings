...
import net.instantbuidlings.procedures.Place_shopProcedure;
...
public class ShopBlock extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:shop")
	public static final Block block = null;
	public ShopBlock(InstantbuidlingsModElements instance) {
		super(instance, 18);
	}

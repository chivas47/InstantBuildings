...
import net.instantbuidlings.procedures.Placep4Procedure;
...
public class P4Block extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:p_4")
	public static final Block block = null;
	public P4Block(InstantbuidlingsModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Placep4Procedure.executeProcedure($_dependencies);
			}
		}
	}
}

...
public class AutodoorBlock extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:autodoor")
	public static final Block block = null;
	public AutodoorBlock(InstantbuidlingsModElements instance) {
		super(instance, 45);
	}

...
import net.instantbuidlings.procedures.Placep3Procedure;
...
public class P3Block extends InstantbuidlingsModElements.ModElement {
	@ObjectHolder("instantbuidlings:p_3")
	public static final Block block = null;
	public P3Block(InstantbuidlingsModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				Placep3Procedure.executeProcedure($_dependencies);
			}
		}
	}
}
